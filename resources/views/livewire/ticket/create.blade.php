<div class="max-w-2xl mx-auto space-y-5">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-xl font-semibold tracking-tight text-zinc-900 dark:text-white">{{ __('Buat Ticket Baru') }}</h1>
            <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-0.5">{{ __('Laporkan masalah atau ajukan permintaan') }}</p>
        </div>
    </div>

    <form class="space-y-5">
        <flux:card class="p-5 border-l-[3px] border-l-emerald-500 dark:border-l-emerald-400 dark:bg-zinc-900 dark:border-zinc-700/50 shadow-card space-y-5">
            <flux:field>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <flux:field>
                    ...
                    <flux:input wire:model="requester_name" placeholder="{{ __('Nama lengkap') }}" class="dark:bg-zinc-800 dark:border-zinc-700 dark:text-white dark:placeholder-zinc-500" />
            ...
            <flux:field>
                ...
                <div wire:loading wire:target="attachments" class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">{{ __('Mengupload...') }}</div>
                @if ($attachments)
